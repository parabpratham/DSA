...
public class JosephusProblem {
	 ...
	 * then person at position 1 is killed. Finally, the person at position 5 is
	 * killed. So the person at position 3 survives. If n = 7 and k = 3, then
	 * the safe position is 4. The persons at positions 3, 6, 2, 7, 5, 1 are
	...
	public static int josephus(int n, int k) {
		 ...
		 * recursive call josephus(n - 1, k) considers the original position k%n
		 * + 1 as position 1
		 */{
