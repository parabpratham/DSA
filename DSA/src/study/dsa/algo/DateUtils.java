...
public class DateUtils {
	...
	public static Date now() {
		Date now = new Date();
		String systemDateWithTime = DateUtils
				.getApplicationDateWithTime(toString(now));
	...
	public static String dateAdd(String date, int value, String field) {
		...
		// }
		java.util.Date processdate = new java.util.Date(intyear, intmonth,
				intday);
	...
	public static Date applicationDateWithServerTime(Date applicationDate) {
		String applicationDateWithTime = DateUtils
				.getApplicationDateWithTime(toString(applicationDate));
	 ...
	 * @return
	 */
	public static String toStringFormattedWithTime(String applicationDate,
			String timeFormat) {
